...
public class MainListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] title=res.getStringArray(R.array.title);//РѕРіР»Р°РІР»РµРЅРёРµ
        ...
        tvDefect.setOnClickListener(v->{
            if(!etSeatNubmer.getText().toString().trim().equals("")){
                ...
                WorkData.getInstance().getCheckListItemList().add(LoginActivity1.addCheckListItem(detailName,defectsName,LowModelsCHeckboxesTitles,lowlowModelsCHeckboxesTitles,LowModelsCommentsTitles));//С‚СѓС‚ РјРѕР¶РµС€СЊ РјРїРѕРґРїРёС…РёРІР°С‚СЊ РґР°РЅРЅС‹Рµ РЅСѓР¶РЅС‹Рµ
